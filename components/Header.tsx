...
export default function Header() {
  const { setIsMobileNavOpen } = useNavigation() // mobile nav 관련 컨텍스트에서 setIsMobileNavOpen을 가져옴
  // react context로 관리하기 때문에 헤더에서 mobile nav 값을 바꾸면 사이드바에서도 변경된 값을 사용할 수 있음
